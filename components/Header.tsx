...
/** ---------- Cross Creek / Fulshear Area Resources (sample dataset) ----------
...
const ALL_LOCATIONS: LocationItem[] = [
  {
    ...
    description: "Community gym + wellness amenities for residents.",
    featured: true,
  },
  {
    id: "ful-2",
    title: "Flewellen Creek Park & Trails",
    address: "Flewellen Creek area, Fulshear, TX (Trails/Park)",
    ...
    description: "Walking trails + outdoor spaces for families and fitness.",
    featured: true,
  },
  {
    id: "ful-3",
    ...
    description: "Questions, help, announcements, and community guidance.",
    featured: true,
  },
  {
    id: "ful-4",
    ...
    host: "Cross Creek Ranch",
    description: "Seasonal pool access + occasional community pool events.",
  },
  {
    id: "ful-5",
    title: "HEB (Nearby Grocery)",
    address: "Fulshear/Katy area grocery (HEB)",
    position: { lat: 29.6912, lng: -95.9185 },
    eventType: "Grocery",
    activities: ["Shopping", "Food", "Family"],
    when: "Daily • 6:00 AM – 11:00 PM",
    host: "HEB",
    description: "Groceries + pharmacy + essentials for residents.",
  },
  {
    id: "ful-6",
    title: "Fulshear Area Public Library",
    address: "Fulshear, TX (Library)",
    position: { lat: 29.6883, lng: -95.9004 },
    eventType: "Library",
    activities: ["Education", "Family"],
    when: "Mon–Sat • Hours vary",
    host: "Public Library",
    description: "Study rooms, reading programs, and student support.",
  },
  {
    id: "ful-7",
    ...
    description: "Food assistance and referral support for families.",
  },
  {
    id: "ful-8",
    ...
    description: "Community volunteer cleanup—gloves/bags provided.",
  },
  {
    id: "ful-9",
    ...
    description: "Meet neighbors and learn what’s new in the community.",
  },
  {
    id: "ful-10",
    title: "After-School Study & Tutoring Meetup",
    address: "Nearby library/community study space",
    position: { lat: 29.6891, lng: -95.901 },
    eventType: "Support Services",
    activities: ["Education", "Family", "Support"],
    when: "Tue/Thu • 5:30 PM",
    host: "Volunteer Tutors",
    description: "Homework help + peer tutoring session for students.",
  },
];
...
export default function Page() {
  // ⚠️ NOT CHANGED — using your exact key string
  ...
  const featured = useMemo(() => ALL_LOCATIONS.filter((l) => l.featured).slice(0, 3), []);
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        >
          ...
          >
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {featured.map((loc) => (
                  ...
                  >
                    <div className="text-xs font-semibold text-blue-900">{loc.eventType}</div>
                    <div className="mt-1 text-base font-bold text-slate-900">{loc.title}</div>
                    <div className="mt-2 text-sm text-slate-600">{loc.description ?? loc.address}</div>
            ...
            {/* Spotlight events */}
            <div className="mt-6">
              <div className="text-sm font-semibold text-slate-700 mb-2">Spotlight events</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <h3 className="mt-2 text-lg font-bold text-slate-900">Cross Creek Neighborhood Meetup</h3>
                  <p className="mt-1 text-sm text-slate-600">
                ...
                >
                  ...
                  <h3 className="mt-2 text-lg font-bold text-slate-900">Trails & Park Cleanup Day</h3>
                  <p className="mt-1 text-sm text-slate-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <motion.section
                variants={fadeUp}
                className="relative z-0 rounded-3xl border border-blue-200 bg-[#eaf3ff] shadow-sm overflow-hidden"
              >
                <div className="p-4 sm:p-5 border-b border-blue-200/60">
                  <h3 className="text-lg sm:text-xl font-bold text-[#1E3A8A]">Resource Directory</h3>
                  <p className="text-sm text-slate-600">Tap a card to center it on the map.</p>
                </div>
                        ...
                        {filteredLocations.map((loc) => (
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                <div className="text-sm font-semibold text-blue-900">{loc.eventType}</div>
                                <div className="mt-1 text-base font-bold text-slate-900">{loc.title}</div>
                              </div>
                            ...
                            {loc.description && (
                              <div className="mt-2 text-sm text-slate-600">{loc.description}</div>
                            )}
              ...
              {/* TSA requirement: additional content */}
              <motion.section
                variants={fadeUp}
                className="rounded-3xl border border-blue-200 bg-[#eaf3ff] shadow-sm overflow-hidden"
              >
                <div className="p-4 sm:p-5 border-b border-blue-200/60">
                  <h3 className="text-lg sm:text-xl font-bold text-[#1E3A8A]">Helpful Info</h3>
                  <p className="text-sm text-slate-600">
                ...
                <div className="p-4 sm:p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <InfoCard
                    ...
                    lines={[
                      ...
                      "For urgent food or support needs, use Food Pantry or Support Services categories.",
                      "For after-hours guidance, check the Welcome Center during business hours.",
                    ]}
                  />
                </div>
              </motion.section>

              {/* Suggest a Resource (TSA requirement: form) */}
              <motion.section
                variants={fadeUp}
                className="rounded-3xl border border-blue-200 bg-[#eaf3ff] shadow-sm overflow-hidden"
              >
                <div className="p-4 sm:p-5 border-b border-blue-200/60">
                  ...
                  <p className="text-sm text-slate-600">
                    Residents can submit resources to be reviewed and added.
                  </p>
                </div>
                <div className="p-4 sm:p-5">
                  <SuggestResourceForm />
...
function SearchBox({
  ...
  // Bigger dropdown (more visible) + scroll
  const dropdownClass =
  ...
  return (
    <div ref={boxRef} className="relative z-[9999] rounded-3xl border border-blue-200 bg-white shadow-sm p-3">
      {/* Mode toggle */}
      ...
      <div className="relative">
        ...
        {currentValue.trim().length > 0 && (
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="absolute right-2 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-blue-600 text-white shadow-sm flex items-center justify-center"
          >
            ✕
          </motion.button>
        )}
      ...
      <AnimatePresence>
        {(hovered || isActive) && (
          <motion.div
            ...
            transition={{ duration: 0.18, ease: "easeOut" }}
            className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 bg-blue-700 text-white text-xs rounded-2xl px-3 py-2 shadow-xl w-60 pointer-events-none"
          >
  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="md:col-span-2 flex items-center justify-between gap-3 flex-wrap">
        <div className="text-xs text-slate-600">Submissions are reviewed before being added.</div>
        <motion.button
          whileHover={{ y: -1 }}
          whileTap={{ scale: 0.99 }}
          type="submit"
