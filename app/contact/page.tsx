...
export default function ContactPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full border-b border-primary/30 bg-base-100">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8 py-5 flex items-center justify-between">
          <motion.div variants={fadeUp} className="flex items-center gap-3">
            <Link
              href="/"
              className="text-xl font-extrabold tracking-tight text-primary hover:opacity-90 transition"
            >
              Gatherly
            </Link>
          ...
          <motion.nav variants={fadeUp} className="flex items-center gap-4 text-sm">
