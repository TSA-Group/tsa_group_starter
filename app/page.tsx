...
+            whileHover={{ y: -4 }}
+          >
+            <h3 className="text-lg font-semibold mb-1 text-gray-100">Quick Actions</h3>
+            <p className="text-sm text-emerald-300/80">One highlighted action you cannot miss.</p>
...
+                  <span className="text-xs font-semibold text-emerald-300">Go</span>
+                </div>
+              ))}
+            </div>
+          </motion.div>
...
+          <motion.div
+            variants={cardPop}
+            className="w-full md:w-[88%] h-[350px] bg-gray-900/70 backdrop-blur-xl rounded-2xl 
+            border border-gray-800 shadow-2xl p-4 relative 
...
+                <li
+                  key={i}
+                  className="bg-gray-800/80 backdrop-blur-xl 
+                  border border-gray-700 rounded-lg p-3 shadow-lg hover:shadow-xl transition"
+                >
...
+                      </div>
+                    </div>
+                    <div className="text-xs text-emerald-300 font-medium">Details</div>
+                  </div>
+
...
+            whileHover={{ y: -4 }}
+          >
+            <h2 className="text-3xl font-semibold text-gray-100">Upcoming Events</h2>
...
+              key={i}
+              variants={cardPop}
+              className="h-36 bg-gray-900/80 rounded-xl border border-gray-800 shadow-md 
...
+                <div className="text-lg font-medium text-gray-100">Neighborhood Meetup</div>
...
+            <a className="text-emerald-300" href="mailto:Gatherly@gmail.com">Gatherly@gmail.com</a>
+            <a className="text-emerald-300" href="tel:012-345-6789">012-345-6789</a>
